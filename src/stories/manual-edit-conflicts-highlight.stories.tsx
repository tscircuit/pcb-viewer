...
const meta: Meta<typeof ManualConfliictsWarningBox> = {
  title: "Manual Edits Conflicts",
  component: ManualConfliictsWarningBox,
}
export default meta

type Story = StoryObj<typeof ManualConfliictsWarningBox>
