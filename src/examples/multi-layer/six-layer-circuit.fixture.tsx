...
export const SixLayerCircuit: React.FC = () => {
  const circuitJson: AnyCircuitElement[] = [
    ...
    // Traces on each layer
    {
      ...
      route: [
        { x: -15, y: 0, width: 0.2, layer: "top" },
        { x: -12, y: 0, width: 0.2, layer: "top" },
      ],
    },
    {
      type: "pcb_trace",
      ...
      route: [
        ...
        { x: -6, y: 0, width: 0.2, layer: "inner1" },
      ],
    },
    {
      type: "pcb_trace",
      ...
      route: [
        ...
        { x: 0, y: 0, width: 0.2, layer: "inner2" },
      ],
    },
    {
      type: "pcb_trace",
    ...
    },
    {
      ...
      route: [
        ...
        { x: 12, y: 0, width: 0.2, layer: "inner4" },
      ],
    },
    {
      type: "pcb_trace",
      ...
      route: [
        { x: 12, y: 0, width: 0.2, layer: "bottom" },
        { x: 15, y: 0, width: 0.2, layer: "bottom" },
      ],
    },
  ] as any
